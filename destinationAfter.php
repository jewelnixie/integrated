...
<body>
        ...
        <nav class="navbar navbar-expand-lg bg-light animate__animated animate__fadeInDown">
            ...
            <a class="navbar-brand" href="#">
              <img src="images/visitaLogo.png" alt="Logo" width="40" height="40" class="d-inline-block align-top"> VisitaPinas
            </a>
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <a class="nav-link dropdown-toggle animate__fadeInDown" href="destinationAfter.php" id="destinationDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        Destination
                    </a>
                    ...
                    <!-- Contact Us -->
                    <li class="nav-item">
                    <a class="nav-link animate__fadeInDown" href="contactUs.php">Contact Us</a>
                    </li>
                </ul>
    ...
    <section class="custom-slider-section">
        ...
        <div class="custom-testimonials">
            <label class="custom-item" for="custom-ct-1">
                <img src="images/beachhh.jpg" alt="Image 1">
            ...
            <label class="custom-item" for="custom-ct-2">
                <img src="images/hikinggg.jpg" alt="Image 2">
            ...
            <label class="custom-item" for="custom-ct-3">
                <img src="images/campinggg.jpg" alt="Image 3">
            ...
            <label class="custom-item" for="custom-ct-4">
                <img src="images/adventure.jpg" alt="Image 4">
            ...
            <label class="custom-item" for="custom-ct-5">
                <img src="images/roadtrip.jpg" alt="Image 5">
        ...
        <div id="customBannerCarousel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="3000">
            <div class="carousel-inner custom-carousel-inner">
                ...
                <div class="carousel-item active custom-carousel-item">
                    <div class="custom-banner-slide" style="background-image: url('images/banner1.png');">
                    </div>
                </div>
                <!-- Second Slide -->
                <div class="carousel-item custom-carousel-item">
                    <div class="custom-banner-slide" style="background-image: url('images/banner2.png');">
                    </div>
                </div>
                <!-- Third Slide -->
                <div class="carousel-item custom-carousel-item">
                    <div class="custom-banner-slide" style="background-image: url('images/banner3.png');">
                    </div>
                </div>
            </div>
            <!-- Carousel Controls -->
        ...
        <div class="row g-4 special-offer-cards">
            ...
            <div class="col-md-4">
                <div class="card category-card position-relative">
                    <img src="images/batanes.jpg" alt="Hiking Image" class="card-img-top">
                    <div class="rating">
            ...
            <div class="col-md-4">
                <div class="card category-card position-relative">
                    <img src="images/cebu.jpg" alt="Beach Image" class="card-img-top">
                    <div class="rating">
            ...
            <div class="col-md-4">
                <div class="card category-card position-relative">
                    <img src="images/palawan.jpg" alt="Camping Image" class="card-img-top">
                    <div class="rating">
